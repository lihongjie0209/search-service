...
func NewHandler(healthService *health.Service, searchService *searchapp.Service, access *searchauth.Resolver, logger *slog.Logger) *Handler {
	return &Handler{health: healthService, search: searchService, access: access, logger: logger}
}
