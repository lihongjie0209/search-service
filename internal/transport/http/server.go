...
import (
	...
	docs "github.com/lihongjie0209/search-service/docs"
	"github.com/lihongjie0209/search-service/internal/auth"
	"github.com/lihongjie0209/search-service/internal/buildinfo"
	"github.com/lihongjie0209/search-service/internal/config"
	"github.com/lihongjie0209/search-service/internal/health"
	"github.com/lihongjie0209/search-service/internal/observability"
	"github.com/lihongjie0209/search-service/internal/ratelimit"
...
func NewServer(lc fx.Lifecycle, cfg config.Config, handler *Handler, authService *auth.Service, limiter *ratelimit.Limiter, metrics *observability.Metrics, tracing *observability.Tracing, logger *slog.Logger) (*http.Server, error) {
	...
	api.POST("/search/query", handler.Search)
	api.POST("/search/suggest", handler.Suggest)
	api.POST("/search/get", handler.GetSearchDocument)
